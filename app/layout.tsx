...
export const metadata = {
  title: 'Francesca | Personal Portfolio',
  description: 'Francesca is a Full Stack Developer and UX Designer.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative h-[5000] pt-28 sm:pt-36`}>
